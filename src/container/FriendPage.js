...
export default function FriendPage() {
  ...
  return (
    <div>
      ...
      <NumberSelect value={ageLimit} options={AGE_LIMIT_OPIONS} label='세 이하만 보기' onChange={setAgeLimit}/>
      <FriendList friends={friendsWithAgeLimit}/>
      <NumberSelect value={nameLenLimit} options={NAME_LEN_LIMIT_OPIONS} label='자 이하 이름만 보기' onChange={setNameLen}/>
...
const AGE_LIMIT_OPIONS = [15, 20, 25, MAX_AGE_LIMIT]
const MAX_NAME_LEN_LIMIT= 100;
const NAME_LEN_LIMIT_OPIONS = [2, MAX_NAME_LEN_LIMIT]